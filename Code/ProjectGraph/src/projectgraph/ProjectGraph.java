...
public class ProjectGraph {
    ...
    public int[][] matrix = new int[5][5]; //file matrix
    public int[][] adjMatrix = new int[5][5]; //adjcency matrix
    public int[][] dijMatrix = new int[5][5]; //dijkstra matrix
