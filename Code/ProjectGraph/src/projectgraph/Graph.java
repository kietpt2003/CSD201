...
public class Graph {
    ...
    int[][] matrix = new int[5][5]; //matrix file
    int[][] adjMatrix = new int[5][5]; //adjcency matrix
    ...
    String[] vertex = new String[5]; //A, B, C,...
    Edges[] edges; //e1, e2, e3,...
    int countEdge = 0;
    int[][] dijMatrix = new int[5][5]; //Dijkstra Matrix
    ...
    String[] verKrus = new String[5]; //Cũng là A, B, C,... (verKrus = vertex original chưa sắp xếp)
